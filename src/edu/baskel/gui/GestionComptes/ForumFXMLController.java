                ...
                ListCell<Forum1> cell = new ListCell<Forum1>() {
                    ...
                    protected void updateItem(Forum1 e, boolean btl) {
                        ...
                        if (e != null) {
                            ...
                            listeforum.setOnMouseClicked(new EventHandler<MouseEvent>() {
                                ...
                                public void handle(MouseEvent event) {
                                    if (event.getButton() == MouseButton.PRIMARY && event.getClickCount() == 2) {
                                        ...
                                        alert.setHeaderText("signaler ce  commentaire !?");
                                        alert.setContentText("comfirme?");
                                        Optional<ButtonType> result = alert.showAndWait();
                                        if (result.get() == ButtonType.OK) {
                                            fs.signalerforum(M);
                                            Alert alert1 = new Alert(Alert.AlertType.CONFIRMATION);
                                            alert1.setHeaderText("Votre signalisation a ete envoyer avec succes ");
                            ...
                            if (e.getId_u() != 0) {
                                setText("Membre  : " + m.getNom_u() + " " + m.getPrenom_u()
                                        + " ,  DATE : " + e.getDate_f()
                                        + "\n" + "Commantaire :  \n " + e.getText()
                                );
                            }
